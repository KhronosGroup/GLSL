...
ANTORA_EXTMODULE = antora/glslext/modules/glslext

# Write GLSL extensions
ext setup_glslext_antora:
	$(QUIET)$(PYTHON) $(SCRIPTS)/antora-glslext-prep.py \
	    -root extensions \
	    -component $(shell realpath $(ANTORA_EXTMODULE)) \
	    `find extensions -name 'GL*.txt'`
