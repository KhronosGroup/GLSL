...
:repo: https://github.com/KhronosGroup/GLSL/blob/main/extensions
...
- link:{repo}/khr/GL_KHR_cooperative_matrix.txt[GL_KHR_cooperative_matrix]
...
- link:{repo}/ext/GL_EXT_function_control_attributes.txt[GL_EXT_function_control_attributes]
- link:{repo}/ext/GLSL_EXT_cooperative_matrix_maintenance1.txt[GL_EXT_cooperative_matrix_maintenance1]
- link:{repo}/ext/GLSL_EXT_split_barrier.txt[GLSL_EXT_split_barrier.txt]
